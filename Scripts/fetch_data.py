...
def analyze_stock(
    ...
    try:
        ...
        # 注意：
        #
        # macd_positive 與 macd_golden_cross
        # 不再重複加分。
        #
        # 如果黃金交叉 → 20
        # 否則柱體正值 → 10
...
def main():
    ...
    for index, stock in enumerate(
        ...
        print(
            f"OK | "
            f"價格="
            f"{result['price']['close']} | "
            f"RSI="
            f"{result['technical']['rsi']} | "
            f"AI="
            f"{result['short_term']['score']}"
        )
